 ...
 const sections = Object.keys(groupedClients).map(initial => ({
  ...
  return (
        ...
        <View style={styles.formContainer}>
         ...
         <Text style={styles.Selecttext1}>Selectionner un client</Text>
         <Text style={styles.Selecttext2}>Sélectionnez un client pour lui affecter la facture. Celle-ci peut être configurée comme payée, impayée, ou partiellement payée.</Text>
