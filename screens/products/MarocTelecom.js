...
export default function MarocTelecom({ AddProduct, item }) {
  // State variables
  ...
  const productsWithoutEAN = [
   { id: '1', name: 'Recharge Maroc Telecom 5Dh',brand:'', quantity:1,price:5, stock:0, nearbySolde:12, timesSold:50, avatar:'', ean:'', icon: 'call' },
   { id: '2', name: 'Recharge 10Dh',brand:'', quantity:1,price:10, stock:0, nearbySolde:12, timesSold:50, avatar:'', ean:'', icon: 'call' },
   { id: '3', name: 'Recharge 20Dh',brand:'', quantity:1,price:20, stock:0, nearbySolde:12, timesSold:50, avatar:'', ean:'', icon: 'call' },
   { id: '4', name: 'Recharge 50Dh',brand:'', quantity:1,price:50, stock:0, nearbySolde:12, timesSold:50, avatar:'', ean:'', icon: 'call' },
   { id: '5', name: 'Recharge 100Dh',brand:'', quantity:1,price:100, stock:0, nearbySolde:12, timesSold:50, avatar:'', ean:'', icon: 'call' },
   { id: '6', name: 'Recharge 200Dh',brand:'', quantity:1,price:200, stock:0, nearbySolde:12, timesSold:50, avatar:'', ean:'', icon: 'call' },
 ];
     ...
     >
       <TouchableOpacity style={styles.productCard1} onPress={() => AddProduct(item)}>
         <View style={styles.column0}>
           ...
           <Ionicons name={item.icon} size={width * 0.1}  color='white' style={styles.icon}/>
         </View>
