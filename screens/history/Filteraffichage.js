  ...
  return (
    ...
    <TouchableOpacity style={styles.ActionBottom}>
      <View style={styles.column0000}>
        <Ionicons name="list" size={width * 0.08} style={styles.icon} />
      </View>
      <View style={styles.column1}>
        <Text style={styles.productNameAction}>Affichage</Text>
      </View>
    </TouchableOpacity>

    <TouchableOpacity style={styles.ActionBottom} onPress={() => filter(1)}>
      <View style={styles.column1}>
        <Text style={styles.productNameAction}>Detaillé par jour (Par défaut)</Text>
      </View>
    </TouchableOpacity>

    <TouchableOpacity style={styles.ActionBottom} onPress={() => filter(2)}>
      <View style={styles.column1}>
        <Text style={styles.productNameAction}>Compliqué par jour</Text>
      </View>
    </TouchableOpacity>
    <TouchableOpacity style={styles.ActionBottom} onPress={() => filter(3)}>
      <View style={styles.column1}>
        <Text style={styles.productNameAction}>Compliqué par mois</Text>
      </View>
    </TouchableOpacity>
    </View>
  );
