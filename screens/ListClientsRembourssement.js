...
export default function App({ navigation, route }) {
  ...
  useEffect(() => {
    // Simulate a loading period (e.g., API call)
    ...
    >
      ...
      <View style={styles.column1}>
        ...
        <View style={styles.column2}>
          ...
          <Text style={styles.date}><Ionicons name="alert-circle-outline" size={width * 0.025} color="#D15D5D"/> {item.nbrinvoice} invoices en retard  </Text>
