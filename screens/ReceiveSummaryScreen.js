...
const ReceiveSummaryScreen = ({navigation, route }) => {
    ...
    <ApplicationProvider {...eva} theme={eva.light}>
        ...
        <View style={styles.cardContent}>
            ...
            <Ionicons name="receipt" size={width * 0.1} color='white' style={styles.icon} />
              ...
              <View style={styles.column2}>
                <Text style={styles.Selecttext88}>RB #{clientInvoice.idunique}</Text>
          </View>
        </View>
      ...
      <View style={styles.fixedHeader}>
        ...
        <View style={styles.header}>
          ...
          <View>
          <Text style={styles.Selecttext}>Yassine Jennane</Text>

            <Text style={styles.Selecttext3}>122 Business Rd, Business CIty, BC..</Text>

            <Text style={styles.Selecttext3}>Date : {clientInvoice.date}</Text>
            <Text style={styles.Selecttext3}>Time : {clientInvoice.time}</Text>
          </View>
    ...
    <Divider style={styles.divider} />
      <View style={styles.montant}>
        <Text style={styles.Selecttext2}>Le montant du remboursement</Text>
          <Divider style={styles.divider} />
         <Text style={styles.Selecttext}>{clientInvoice.nbrpaid} Dh</Text>

      </View>
      <Divider style={styles.divider} />
      <View style={styles.description}>
      <Text style={styles.Selecttext2}>Description to this transaction:  </Text>
        <Divider style={styles.divider} />
       <Text style={styles.Selecttext7}>{clientInvoice.description}</Text>
      </View>
